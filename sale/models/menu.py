...
class Button(models.Model):
  ...
  type = models.CharField(u'响应动作类型', max_length=20, choices=BUTTON_TYPE, null=True, blank=True,help_text=u'自定义菜单接口按钮类型，注意除click和view事件外，其余事件需要微信iPhone5.4.1以上版本支持。')
  parent = models.ForeignKey('self', verbose_name='父级菜单', null=True, blank=True)
  key = models.CharField(u'KEY值', max_length=128, blank=True, help_text=u'事件KEY值，用于与事件响应规则关联。跳转URL型的菜单无需此项。')
